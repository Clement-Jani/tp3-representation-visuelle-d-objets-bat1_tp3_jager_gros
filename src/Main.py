...
def Q4a():
    ...
    wall1 = Wall({"width" : 7, "height" : 3})
    wall2 = Wall({"position" : [0,2,0], "width" : 7, "height" : 3})
    wall3 = Wall({"position" : [0,0,0], "width" : 2.2, "height" : 3, "orientation" : 90})
    wall4 = Wall({"position" : [0,-7,0], "width" : 2.2, "height" : 3, "orientation" : 90})  
